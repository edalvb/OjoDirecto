...
abstract class AppLocalizations {
  ...
  /// No description provided for @scriptHint.
  ///
  /// In en, this message translates to:
  /// **'Write your script here...'**
  String get scriptHint;

  /// No description provided for @speedIncrease.
  ///
  /// In en, this message translates to:
  /// **'+ Speed'**
  String get speedIncrease;

  /// No description provided for @speedDecrease.
  ///
  /// In en, this message translates to:
  /// **'- Speed'**
  ...
  String get selectFolderDialog;

  /// No description provided for @defaultScript.
  ///
  /// In en, this message translates to:
